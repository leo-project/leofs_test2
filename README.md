...
12. check whether access_key_id and secret_access_key pairs generated by (create|import)-user works with erlcloud
13. check whether GET with Range header works on both protocols(S3 and REST)
